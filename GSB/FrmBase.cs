...
namespace GSB {
    public partial class FrmBase : Form {
        ...
        private void programmerRendezVous_Click(object sender, EventArgs e) {
            FrmEnregistrerRdv unFrmSaisieVisite = new FrmEnregistrerRdv();
        ...
        private void modifierRendezVous_Click(object sender, EventArgs e) {
            FrmModificationRdv unFrmModificationRdv = new FrmModificationRdv();
            unFrmModificationRdv.Show();
            Close();
        ...
        private void imprimerRendezvous_Click(object sender, EventArgs e) {
            FrmImpressionRdv unFrmImpressionRdv = new FrmImpressionRdv();
            unFrmImpressionRdv.Show();
            Close();
        ...
        private void consulterVisite_Click(object sender, EventArgs e) {
            FrmConsultationVisite unFrmConsultationVisite = new FrmConsultationVisite();
            unFrmConsultationVisite.Show();
            Close();
        }

        // consultation des médicaments
        private void ficheMédicamentToolStripMenuItem_Click(object sender, EventArgs e) {
            FrmFicheMedicament unFrmMedicament = new FrmFicheMedicament();
        ...
        private void modifierPraticien_Click(object sender, EventArgs e) {
            FrmModificationPraticien unFrmModificationPraticien = new FrmModificationPraticien();
            unFrmModificationPraticien.Show();
            Close();
